        ...
        <div class="row">
            <div class="col-md-12 my-2">
                <div class="float-start">
                    <a href="{{ route('member#product') }}" class="btn btn-link"><i class="fa-sharp fa-solid fa-arrow-left-long"></i> Back</a>
                </div>
            </div>
            <div class="col-md-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="row">
                        <div class="col-md-4 offset-8 float-end">
                            <img src="{{ asset('images/'.$product->image) }}" style="width: 200px;height:200px" alt="">
                        </div>
                    </div>
                    <form action="{{ route('member#product_update',$product->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="p-name" class="form-label">Name</label>
                            <input required type="text" name="name" autocomplete="none" value="{{ old('name',$product->name) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select required name="categoryId" id="p-category"
                                        ...
                                        <option @if (old('categoryId',$product->category_id) == $c->id) selected @endif value="{{ $c->id }}">{{ $c->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                        @error('categoryId')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input required type="number" name="qty" value="{{ old('qty',$product->qty) }}"
                        ...
                        <div class="mb-3 d-none">
                            ...
                            <textarea name="information" required class="form-control" id="p-info" rows="1">{{ old('information',$product->information) }}</textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" required class="form-control" id="p-desc" rows="6">{{ old('description',$product->description) }}</textarea>
                        </div>
